...
CREATE TABLE IF NOT EXISTS public.onboarding_signature_events (
...
CREATE INDEX IF NOT EXISTS onboarding_signature_events_user_document_signed_at_idx
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'onboarding_signature_events'
      AND policyname = 'Users can view their own onboarding signature events'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'onboarding_signature_events'
      AND policyname = 'Users can insert their own onboarding signature events'
  ) THEN
