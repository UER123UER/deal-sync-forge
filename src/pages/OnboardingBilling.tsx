    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Complete your brokerage membership through Stripe ACH bank debit. Promo codes can be entered at checkout.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="rounded-2xl border bg-background p-6">
            ...
            <ul className="mt-5 space-y-2 text-sm">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-emerald-500" />
                <span>Apply a promo code on the Stripe checkout page</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3">
            ...
            <div className="text-sm leading-relaxed text-blue-800">
              ...
              <p className="text-xs text-blue-700/90">
                ...
                authorize the recurring monthly ACH debit. Have a promo code? Enter it on the Stripe checkout page.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
            ...
            <span>Bank credentials are handled by Stripe and never stored on our servers.</span>
          </div>
        </CardContent>
      </Card>
    </div>
