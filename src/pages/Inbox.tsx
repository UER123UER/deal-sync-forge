  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="h-14 border-b flex items-center px-6 gap-4">
        ...
        <Button size="sm" className="text-xs gap-1.5" onClick={() => toast.info('Email composition coming soon')}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="gap-2" onClick={() => toast.info('Google email integration coming soon')}>
          ...
          <Button variant="outline" className="gap-2" onClick={() => toast.info('Outlook email integration coming soon')}>
