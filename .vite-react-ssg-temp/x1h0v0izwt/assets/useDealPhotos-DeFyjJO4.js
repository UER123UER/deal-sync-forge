...
function AdjustableBlock({
  ...
  return /* @__PURE__ */ jsxDEV(
    ...
    false,
    {
      fileName: "/dev-server/src/data/marketingTemplates.tsx",
      lineNumber: 269,
      columnNumber: 5
    },
    this
      ...
      AdjustableBlock,
      {
        ...
        children: /* @__PURE__ */ jsxDEV(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxDEV(E, { editable, children: block.text }, void 0, false, {
              fileName: "/dev-server/src/data/marketingTemplates.tsx",
              lineNumber: 326,
              columnNumber: 11
            }, this)
...
const Logo = ({ width = 300 }) => /* @__PURE__ */ jsxDEV(
  "img",
  {
    src: "/logo.png",
...
function renderHeadlineBlock(style, headline, fallback, editable, fontScale = 1) {
  ...
  if (style === "h2") {
    return /* @__PURE__ */ jsxDEV("div", { style: { marginBottom: Math.round(16 * fontScale) }, children: [
      /* @__PURE__ */ jsxDEV(
        "div",
        {
          style: {
          ...
          children: /* @__PURE__ */ jsxDEV(E, { editable, children: headline }, void 0, false, {
            fileName: "/dev-server/src/data/marketingTemplates.tsx",
            lineNumber: 481,
            columnNumber: 11
          }, this)
  ...
  if (style === "h3") {
    return /* @__PURE__ */ jsxDEV("div", { style: { marginBottom: Math.round(18 * fontScale) }, children: /* @__PURE__ */ jsxDEV(
      "div",
      {
        style: {
  ...
  return /* @__PURE__ */ jsxDEV(
    "div",
    {
      ...
      children: [
        headlineParts.italic ? /* @__PURE__ */ jsxDEV(
          "span",
          {
            style: {
              fontFamily: 'Georgia, "Times New Roman", serif',
            ...
            children: /* @__PURE__ */ jsxDEV(E, { editable, children: headlineParts.italic }, void 0, false, {
              fileName: "/dev-server/src/data/marketingTemplates.tsx",
              lineNumber: 537,
              columnNumber: 11
            }, this)
        ...
        /* @__PURE__ */ jsxDEV(
          "span",
          {
            ...
            children: /* @__PURE__ */ jsxDEV(E, { editable, children: headlineParts.bold }, void 0, false, {
              fileName: "/dev-server/src/data/marketingTemplates.tsx",
              lineNumber: 550,
              columnNumber: 9
            }, this)
...
function renderPhotoBlocks(data) {
  ...
  return photoBlocks.map((block, index) => /* @__PURE__ */ jsxDEV(
    FreeformPhotoBlock,
    {
      block,
      index,
          ...
          children: [
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxDEV(
                  AdjustableBlock,
                  {
                    ...
                    children: /* @__PURE__ */ jsxDEV(Logo, { width: Math.round(360 * fontScale) }, void 0, false, {
                      fileName: "/dev-server/src/data/marketingTemplates.tsx",
                      lineNumber: 681,
                      columnNumber: 15
                    }, this)
            ...
            /* @__PURE__ */ jsxDEV(
              "div",
              {
                ...
                children: [
                  visibility.headline && /* @__PURE__ */ jsxDEV(AdjustableBlock, { data, block: "headline", children: renderHeadlineBlock(data.headlineStyle, data.headline, labelParts, editable, fontScale) }, void 0, false, {
                    fileName: "/dev-server/src/data/marketingTemplates.tsx",
                    lineNumber: 703,
                    columnNumber: 15
                  }, this),
                  visibility.address && /* @__PURE__ */ jsxDEV(AdjustableBlock, { data, block: "address", children: [
                    visibility.headline && /* @__PURE__ */ jsxDEV("div", { style: { width: Math.round(80 * fontScale), height: 2, background: "#c9a96e", margin: `0 auto ${Math.round(22 * fontScale)}px` } }, void 0, false, {
                      fileName: "/dev-server/src/data/marketingTemplates.tsx",
                      lineNumber: 711,
                      columnNumber: 19
                    }, this),
                    /* @__PURE__ */ jsxDEV(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxDEV(E, { editable, children: data.address }, void 0, false, {
                          fileName: "/dev-server/src/data/marketingTemplates.tsx",
                          lineNumber: 724,
                          columnNumber: 19
                        }, this)
                    ...
                    /* @__PURE__ */ jsxDEV(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxDEV(E, { editable, children: [
                          data.city,
                          ", ",
                          data.state,
                          " ",
                  ...
                  visibility.price && /* @__PURE__ */ jsxDEV(AdjustableBlock, { data, block: "price", children: /* @__PURE__ */ jsxDEV(
                    "div",
                    {
                      style: {
                        fontFamily: '"Inter", system-ui, sans-serif',
                      ...
                      children: /* @__PURE__ */ jsxDEV(E, { editable, children: data.price }, void 0, false, {
                        fileName: "/dev-server/src/data/marketingTemplates.tsx",
                        lineNumber: 754,
                        columnNumber: 19
                      }, this)
                  ...
                  visibility.stats && /* @__PURE__ */ jsxDEV(AdjustableBlock, { data, block: "stats", children: /* @__PURE__ */ jsxDEV(
                    "div",
                    {
                      style: {
                        display: "flex",
                      ...
                      children: [
                      ...
                      ].map((item) => /* @__PURE__ */ jsxDEV("div", { style: { minWidth: Math.round(110 * fontScale) }, children: [
                        /* @__PURE__ */ jsxDEV("div", { style: { fontSize: Math.round(28 * fontScale), fontWeight: 700, color: "#ffffff" }, children: /* @__PURE__ */ jsxDEV(E, { editable, children: item.value }, void 0, false, {
                          fileName: "/dev-server/src/data/marketingTemplates.tsx",
                          lineNumber: 778,
                          columnNumber: 25
                        }, this) }, void 0, false, {
                        ...
                        /* @__PURE__ */ jsxDEV("div", { style: { fontSize: Math.round(11 * fontScale), letterSpacing: 2, textTransform: "uppercase", color: "rgba(255,255,255,0.45)", marginTop: 4 }, children: item.label }, void 0, false, {
                          fileName: "/dev-server/src/data/marketingTemplates.tsx",
                          lineNumber: 780,
                          columnNumber: 23
                        }, this)
                  ...
                  visibility.description && /* @__PURE__ */ jsxDEV(AdjustableBlock, { data, block: "description", children: /* @__PURE__ */ jsxDEV(
                    "div",
                    {
                      style: {
                      ...
                      children: /* @__PURE__ */ jsxDEV(E, { editable, children: data.description }, void 0, false, {
                        fileName: "/dev-server/src/data/marketingTemplates.tsx",
                        lineNumber: 801,
                        columnNumber: 19
                      }, this)
                  ...
                  category === "Open House" && /* @__PURE__ */ jsxDEV("div", { style: { marginTop: Math.round(20 * fontScale), fontSize: Math.round(24 * fontScale), color: "#c9a96e", fontStyle: "italic" }, children: [
                    /* @__PURE__ */ jsxDEV(E, { editable, children: data.openHouseDate }, void 0, false, {
                      fileName: "/dev-server/src/data/marketingTemplates.tsx",
                      lineNumber: 808,
                      columnNumber: 17
                    }, this),
                    /* @__PURE__ */ jsxDEV("span", { style: { margin: `0 ${Math.round(12 * fontScale)}px`, color: "rgba(255,255,255,0.3)" }, children: "|" }, void 0, false, {
                      fileName: "/dev-server/src/data/marketingTemplates.tsx",
                      lineNumber: 809,
                      columnNumber: 17
                    }, this),
                    /* @__PURE__ */ jsxDEV(E, { editable, children: data.openHouseTime }, void 0, false, {
                      fileName: "/dev-server/src/data/marketingTemplates.tsx",
                      lineNumber: 810,
                      columnNumber: 17
                    }, this)
                  ...
                  showAgentBlock && /* @__PURE__ */ jsxDEV(AdjustableBlock, { data, block: "agent", children: data.agentLayout === "multi" && agents.length > 1 ? /* @__PURE__ */ jsxDEV(
                    "div",
                    {
                      style: {
                      ...
                      children: agents.map((agent) => /* @__PURE__ */ jsxDEV(
                        "div",
                        {
                          style: {
                          ...
                          children: [
                            visibility.agentName && /* @__PURE__ */ jsxDEV("div", { style: { color: "#ffffff", fontWeight: 700, fontSize: Math.round(15 * fontScale), marginBottom: visibility.agentTitle ? 4 : 8 }, children: agent.name }, void 0, false, {
                              fileName: "/dev-server/src/data/marketingTemplates.tsx",
                              lineNumber: 839,
                              columnNumber: 27
                            }, this),
                            visibility.agentTitle && /* @__PURE__ */ jsxDEV("div", { style: { color: "rgba(255,255,255,0.55)", fontSize: Math.round(12 * fontScale), marginBottom: visibility.agentPhone || visibility.agentEmail ? 10 : 0 }, children: agent.title }, void 0, false, {
                              fileName: "/dev-server/src/data/marketingTemplates.tsx",
                              lineNumber: 844,
                              columnNumber: 27
                            }, this),
                            visibility.agentPhone && /* @__PURE__ */ jsxDEV("div", { style: { color: "rgba(255,255,255,0.82)", fontSize: Math.round(12 * fontScale), marginBottom: visibility.agentEmail ? 4 : 0 }, children: agent.phone }, void 0, false, {
                              fileName: "/dev-server/src/data/marketingTemplates.tsx",
                              lineNumber: 849,
                              columnNumber: 27
                            }, this),
                            visibility.agentEmail && /* @__PURE__ */ jsxDEV("div", { style: { color: "rgba(255,255,255,0.65)", fontSize: Math.round(11 * fontScale), wordBreak: "break-word" }, children: agent.email }, void 0, false, {
                              fileName: "/dev-server/src/data/marketingTemplates.tsx",
                              lineNumber: 854,
                              columnNumber: 27
                            }, this)
                    ...
                    "div",
                    {
                      ...
                      children: [
                        visibility.agentName && /* @__PURE__ */ jsxDEV("span", { style: { color: "#ffffff", fontWeight: 700 }, children: /* @__PURE__ */ jsxDEV(E, { editable, children: data.agentName }, void 0, false, {
                          fileName: "/dev-server/src/data/marketingTemplates.tsx",
                          lineNumber: 878,
                          columnNumber: 25
                        }, this) }, void 0, false, {
                        ...
                        visibility.agentTitle && /* @__PURE__ */ jsxDEV("span", { children: /* @__PURE__ */ jsxDEV(E, { editable, children: data.agentTitle }, void 0, false, {
                          fileName: "/dev-server/src/data/marketingTemplates.tsx",
                          lineNumber: 883,
                          columnNumber: 25
                        }, this) }, void 0, false, {
                        ...
                        visibility.agentPhone && /* @__PURE__ */ jsxDEV("span", { children: /* @__PURE__ */ jsxDEV(E, { editable, children: data.agentPhone }, void 0, false, {
                          fileName: "/dev-server/src/data/marketingTemplates.tsx",
                          lineNumber: 888,
                          columnNumber: 25
                        }, this) }, void 0, false, {
                        ...
                        visibility.agentEmail && /* @__PURE__ */ jsxDEV("span", { children: /* @__PURE__ */ jsxDEV(E, { editable, children: data.agentEmail }, void 0, false, {
                          fileName: "/dev-server/src/data/marketingTemplates.tsx",
                          lineNumber: 893,
                          columnNumber: 25
                        }, this) }, void 0, false, {
            ...
            ((((_a = data.photoBlocks) == null ? void 0 : _a.length) ?? 0) > 0 || (((_b = data.customTextBlocks) == null ? void 0 : _b.length) ?? 0) > 0) && /* @__PURE__ */ jsxDEV("div", { style: { position: "absolute", inset: 0, pointerEvents: "none" }, children: [
