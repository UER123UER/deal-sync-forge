...
const SelectLabel = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(SelectPrimitive.Label, { ref, className: cn("py-2 pl-8 pr-3 text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground", className), ...props }));
